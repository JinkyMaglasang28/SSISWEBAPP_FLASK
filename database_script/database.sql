...
-- Dumping data for table database.college_list: ~0 rows (approximately)
/*!40000 ALTER TABLE `college_list` DISABLE KEYS */;
INSERT INTO `college_list` (`college_name`, `college_code`) VALUES
...
CREATE TABLE IF NOT EXISTS `course_list` (
  ...
  KEY `FK__college_list` (`college`),
  CONSTRAINT `FK__college_list` FOREIGN KEY (`college`) REFERENCES `college_list` (`college_name`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Dumping data for table database.course_list: ~0 rows (approximately)
...
) ENGINE=InnoDB AUTO_INCREMENT=20181594 DEFAULT CHARSET=utf8;

-- Dumping data for table database.student_list: ~0 rows (approximately)
/*!40000 ALTER TABLE `student_list` DISABLE KEYS */;
INSERT INTO `student_list` (`stud_id`, `fname`, `lname`, `course`, `year_lvl`, `gender`) VALUES
	(426, 'Jinky', 'Maglasang', 'BSCS', '4', 'F'),
	(20181592, 'Jinky', 'Maglasang', 'BSCS', '4', 'F'),
	(20181593, 'Jinky', 'Maglasang', 'BSCS', '4', 'F');
